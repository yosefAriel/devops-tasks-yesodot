<template>
  <section class="page-404 bg-purple">
    <div class="stars">
      <div class="central-body">
        <img class="image-404" src="@/assets/images/404.svg" width="300px" />
        <router-link to="/my-drive" class="btn-go-home">{{$t('errors.GoBack')}}</router-link>
      </div>
      <div class="objects">
